...
class ChallengeCardArgs extends StoryArgs<ChallengeCard> {
  ...
  ChallengeCardArgs.fixed({
    ...
    void Function()? onTap,
        ...
        this.earnedPointsArg =
            earnedPoints == null ? null : Arg.fixed(earnedPoints),
        this.epochPointsArg =
            epochPoints == null ? null : Arg.fixed(epochPoints),
        this.completedPointsArg =
            completedPoints == null ? null : Arg.fixed(completedPoints),
