  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        _subsectionTitle(context, '4B. The Two-Color Text System'),
        _annotationBox(
          context,
        ...
        // 4E: The anti-pattern
        _subsectionTitle(context, '4E. The Signal-to-Noise Ratio'),
        _annotationBox(
          context,
      ...
      children: [
        ...
        const Wrap(
          ...
          children: [
            ...
            Button(label: 'Tonal', variant: ButtonVariant.tonal, onTap: _noop),
            Button(
              label: 'Outlined',
