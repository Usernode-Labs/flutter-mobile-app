...
class ImportSeedScreen extends StatefulWidget {
  ...
  const ImportSeedScreen({super.key, required this.initialName});
...
class ImportPrivateKeyScreen extends StatefulWidget {
  final String initialName;
  const ImportPrivateKeyScreen({super.key, required this.initialName});
                    ...
                    child: FilledButton(
                      onPressed: _valid
                          ? () {
                              ...
                              Navigator.pop(
                                context,
                                ImportPrivateKeyData(name: name, privateKey: pk),
                              );
                            }
                          : null,
                      child: const Text('Import'),
