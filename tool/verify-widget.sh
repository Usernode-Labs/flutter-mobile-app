...
LEGACY_M3_CONTAINER_ALLOWED="block_production_status_card bottom_nav button challenge_event_group dapp_card dropdown_sheet epoch_performance_page slot_assignments_page top_status_app_bar zk_identity_flow_page"
LEGACY_MISSING_TEST_ALLOWED="challenge_category_tile challenge_event_group dapp_avatar dapp_card status_text_trailing zk_identity_step_illustration"
