...
class ChallengeDetailPageArgs extends StoryArgs<ChallengeDetailPage> {
  ...
  ChallengeDetailPageArgs.fixed({
    ...
    void Function()? onCtaTap,
        ...
        this.statusSectionArg =
            statusSection == null ? null : Arg.fixed(statusSection),
        this.sectionsArg = Arg.fixed(sections),
        this.totalRewardHeadingArg =
            totalRewardHeading == null ? null : Arg.fixed(totalRewardHeading),
        this.totalRewardBodyArg =
            totalRewardBody == null ? null : Arg.fixed(totalRewardBody),
