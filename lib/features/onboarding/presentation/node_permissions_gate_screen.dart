...
Future<NodePermissionGateState> readNodePermissionGateState(
  ...
  // Only Android producers have permissions to gate. Notification permission
  // is requested by the SV shell's onboarding sheet, so it is not checked here.
  if (defaultTargetPlatform != TargetPlatform.android || !hasWallet) {
