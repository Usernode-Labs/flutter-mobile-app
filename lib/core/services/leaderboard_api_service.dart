...
class LeaderboardApiService {
  ...
  /// Records the participant's decision on a terms version.
  ///
  /// [termsVersionId] must be the `id` from [getCurrentTerms] — the backend
  /// rejects a stale or unpublished version with HTTP 422. Posting again for
  /// the same version overwrites the previous decision, which is how a user
  /// changes their mind or withdraws consent.
