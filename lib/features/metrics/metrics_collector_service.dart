...
class MetricsCollectorService {
  ...
  /// Collect P2P-specific metrics for separate reporting
  ///
  /// Returns a simplified Map for P2P metrics API endpoint
  Future<Map<String, dynamic>?> collectP2PMetrics() async {
    if (!RustBackendService.instance.isRunning) {
      _log.debug('Node not running, skipping P2P metrics collection');
      return null;
    }
