      ...
      child: Column(
        ...
        children: [
          ...
          _colorRow(context, [
            ...
            _SwatchData('onPrimaryContainer', cs.onPrimaryContainer,
                cs.primaryContainer),
          ]),
          ...
          _colorRow(context, [
            ...
            _SwatchData('secondaryContainer', cs.secondaryContainer,
                cs.onSecondaryContainer),
            _SwatchData('onSecondaryContainer', cs.onSecondaryContainer,
          ...
          _colorRow(context, [
            ...
            _SwatchData('tertiaryContainer', cs.tertiaryContainer,
                cs.onTertiaryContainer),
            _SwatchData('onTertiaryContainer', cs.onTertiaryContainer,
    ...
    return Column(
      ...
      children: [
        ...
        _colorRow(context, [
          ...
          _SwatchData(
              'colorContainer', group.colorContainer, group.onColorContainer),
          _SwatchData(
...
class _GuidelinesCatalogState extends State<GuidelinesCatalog> {
  ...
  Future<void> _loadMarkdown() async {
    try {
      final raw =
          await rootBundle.loadString('lib/design_system/DESIGN_SYSTEM.md');
      final philosophy = extractSection(raw, '<!-- COLOR_PHILOSOPHY_START -->',
          '<!-- COLOR_PHILOSOPHY_END -->');
      final dosDonts = extractSection(raw, '<!-- COLOR_DOS_DONTS_START -->',
          '<!-- COLOR_DOS_DONTS_END -->');
      setState(() {
