...
abstract class AppLocalizations {
  ...
  /// Title shown after selecting a different network in diagnostics
  ///
  /// In en, this message translates to:
  /// **'Network changed'**
  String get networkRestartTitle;

  /// Relaunch instruction after selecting a different network in diagnostics
  ///
  /// In en, this message translates to:
