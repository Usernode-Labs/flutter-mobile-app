...
class DSTextFieldArgs extends StoryArgs<DSTextField> {
  DSTextFieldArgs({
    ...
    Arg<FocusNode?>? focusNode,
        ...
        this.textInputActionArg = $initArg(
          'textInputAction',
          textInputAction,
          NullableEnumArg<TextInputAction>(null,
        ...
        this.minLinesArg =
            $initArg('minLines', minLines, NullableIntArg(null))!,
  ...
  DSTextFieldArgs.fixed({
    ...
    FocusNode? focusNode,
        ...
        this.keyboardTypeArg =
            keyboardType == null ? null : Arg.fixed(keyboardType),
        this.textInputActionArg =
            textInputAction == null ? null : Arg.fixed(textInputAction),
        ...
        this.inputFormattersArg =
            inputFormatters == null ? null : Arg.fixed(inputFormatters),
